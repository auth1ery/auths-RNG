(function (root) {
  ...
  function Xoshiro256SS(seed) {
    this._s = [0n, 0n, 0n, 0n];
    this.reseed(seed !== undefined ? seed : BigInt(Date.now()) ^ BigInt(Math.floor((typeof performance !== 'undefined' ? performance.now() : 0) * 1e6)));
  }
...
// damn this was confusing to make up
